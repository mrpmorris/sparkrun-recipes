# radixark__qwen3.8-27b-nvfp4-mtp-vllm.yaml benchmark results

Generated UTC: 2026-08-15T17:50:51.865437+00:00

## Run

| Key | Value |
| --- | --- |
| Recipe | /home/mrpmorris/sparkrun-recipes/recipes/radixark__qwen3.8-27b-nvfp4-mtp-vllm.yaml |
| Model | RadixArk/Qwen3.8-27B-NVFP4 |
| Served model name | RadixArk/Qwen3.8-27B-NVFP4 |
| Runtime | vllm |
| Container | ghcr.io/spark-arena/dgx-vllm-eugr-nightly:latest |
| Base URL | http://127.0.0.1:8000/v1 |
| Host | Linux 6.17.0-1029-nvidia aarch64 GNU/Linux |
| GPU | NVIDIA GB10 |
| Output dir | /home/mrpmorris/sparkrun-recipes/bench-results/radixark__qwen3.8-27b-nvfp4-mtp-vllm.yaml/20260815-160758 |
| Command | /home/mrpmorris/sparkrun-recipes/benchllm.py --recipe /home/mrpmorris/sparkrun-recipes/recipes/radixark__qwen3.8-27b-nvfp4-mtp-vllm.yaml --cleanup |
| Total duration | 6173 s |
...
| host | 0.0.0.0 |
| port | 8000 |
| served_model_name | RadixArk/Qwen3.8-27B-NVFP4 |
| tensor_parallel | 1 |
| pipeline_parallel | 1 |
...
| --- | --- | --- | --- | --- | --- | --- |
| 256 | 315 | 0.255 | 36.6 | 1233.9 | 27.46 | 9.58 |
| 1024 | 1079 | 0.525 | 34.9 | 2053.9 | 28.79 | 9.42 |
| 4096 | 4155 | 1.831 | 39.7 | 2269.8 | 25.29 | 11.95 |
| 16384 | 16442 | 8.324 | 35.3 | 1975.2 | 28.47 | 17.32 |
| 65536 | 65593 | 45.339 | 39.0 | 1446.7 | 25.74 | 55.28 |
| 259267 | 259321 | 366.149 | 46.8 | 708.2 | 21.47 | 378.07 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | 1 | 0 | 0.494 | 0.494 | 35.79 | 33.5 | 7.65 |
| 2 | 2 | 0 | 0.868 | 0.955 | 24.36 | 41.4 | 12.35 |
| 4 | 4 | 0 | 1.890 | 1.890 | 28.96 | 86.2 | 11.88 |
| 8 | 8 | 0 | 3.872 | 3.874 | 22.22 | 130.8 | 15.66 |
| 16 | 16 | 0 | 8.095 | 8.101 | 18.64 | 180.1 | 22.75 |
...
| --- | --- | --- | --- | --- | --- |
| mmlu | General knowledge across 57 academic subjects | acc,none | 0.7035 | 0.0190 |  |
| gsm8k | Grade-school math word problems (multi-step reasoning) | exact_match,strict-match | 0.4973 | 0.0138 | 1319 |
| gsm8k | Grade-school math word problems (multi-step reasoning) | exact_match,flexible-extract | 0.5603 | 0.0137 | 1319 |
| mbpp | Coding: basic Python programming problems, graded by unit tests | pass_at_1,none | 0.3660 | 0.0216 | 500 |
...
| --- | --- | --- |
| Qwen3.8-27B-NVFP4@bfcl_v4 | 0.8800 |  |
| acc | 0.8800 | 175 |
